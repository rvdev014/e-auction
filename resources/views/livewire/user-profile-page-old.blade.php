        ...
        <div class="row g-4">
            <div class="col-lg-3">
                <div class="nav flex-column nav-pills gap-4 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".2s"
                    ...
                    <button class="nav-link active nav-btn-style mx-auto mb-20" id="v-pills-profile-tab"
                            data-bs-toggle="pill"
                    ...
                    <button class="nav-link nav-btn-style mx-auto  mb-20" id="v-pills-dashboard-tab"
                            data-bs-toggle="pill"
                    ...
                    <button class="nav-link nav-btn-style mx-auto mb-20" id="v-pills-order-tab" data-bs-toggle="pill"
                            ...
                            <table class="eg-table order-table table mb-0">
                                ...
                                <tr>
                                    ...
                                    <td data-label="Image"><img alt="image"
                                                                src="{{ asset('auction/assets/images/bg/order1.png') }}"
                                                                class="img-fluid"></td>
                                    <td data-label="Status" class="text-green">Successfully</td>
                                    <td data-label="Action">
                                        <button class="eg-btn action-btn green"><img alt="image"
                                                                                     src="{{ asset('auction/assets/images/icons/aiction-icon.svg') }}">
                                        </button>
                                    </td>
                                </tr>
                                </tbody>
