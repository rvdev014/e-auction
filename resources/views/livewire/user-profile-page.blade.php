            ...
            <div class="row g-4">
                <div class="col-lg-3">
                    <div class="nav flex-column nav-pills gap-4 wow fadeInUp">
                        ...
                        <button
                            class="nav-link nav-btn-style mx-auto mb-20 @if($this->tab === 'winning-reports') active @endif"
                            wire:click="setTab('winning-reports')"
                        >
                            <svg width="22" height="22" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            Голиблик баённомалари
                        </button>

                        <button
                            class="nav-link nav-btn-style mx-auto mb-20 @if($this->tab === 'messages') active @endif"
                ...
                <div class="col-lg-9">
                    <div class="tab-content">
                        ...
                        {{--         User data form         --}}
                        <div class="tab-pane fade show @if($this->tab === 'winning-reports') active @endif">
                            @livewire('components.user-winning-reports')
                        </div>

                        {{--         User data form         --}}
                        <div class="tab-pane fade show @if($this->tab === 'messages') active @endif">
                            @livewire('components.user-messages')
                        </div>
